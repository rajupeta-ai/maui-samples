...
public class PlatformSpecificSampleTest : BaseTest
{
	...
	public void SampleTest()
	{
		...
		Assert.That(App.SessionId, Is.Not.Null, "Appium session should be active on iOS");

		// Assert that the app's page source is loaded (UI is rendered)
		Assert.That(App.PageSource, Is.Not.Null.And.Not.Empty, "App page source should not be empty — iOS app must be rendered");
